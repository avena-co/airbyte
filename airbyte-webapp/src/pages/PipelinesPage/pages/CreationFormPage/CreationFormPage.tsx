...
export const CreationFormPage: React.FC = () => {
  ...
  const renderStep = () => {
    ...
    const afterSubmitConnection = (pipeline: WebBackendPipelineRead) => {
      switch (type) {
  ...
  const titleId: string = ({
    [EntityStepsTypes.CONNECTION]: "pipeline.newPipelineTitle",
  ...
  return (
    <>
      <HeadTitle titles={[{ id: "pipeline.newPipelineTitle" }]} />

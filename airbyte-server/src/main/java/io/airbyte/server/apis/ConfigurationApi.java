...
import io.airbyte.server.handlers.PipelinesHandler;
...
import io.airbyte.server.handlers.WebBackendPipelinesHandler;
...
public class ConfigurationApi implements io.airbyte.api.generated.V1Api {
    ...
    private final WebBackendPipelinesHandler webBackendPipelinesHandler;
    ...
    public ConfigurationApi(final ConfigRepository configRepository,
        ...
        webBackendConnectionsHandler = new WebBackendConnectionsHandler(
                ...
                eventRunner,
                configRepository);
        webBackendPipelinesHandler = new WebBackendPipelinesHandler(
                pipelinesHandler,
                connectionsHandler,
                eventRunner,
                configRepository);
    ...
    public PipelineReadList searchPipelines(final PipelineSearch pipelineSearch) {
        return execute(() -> pipelinesHandler.searchPipelines(pipelineSearch));
    }
    ...
    public PipelineReadList listAllPipelinesForWorkspace(final WorkspaceIdRequestBody workspaceIdRequestBody) {
        return execute(() -> pipelinesHandler.listAllPipelinesForWorkspace(workspaceIdRequestBody));
    }
    ...
    public PipelineRead createPipeline(final PipelineCreate pipelineCreate) {
        return execute(() -> pipelinesHandler.createPipeline(pipelineCreate));
    }
    ...
    @Override
    public void deletePipeline(final PipelineIdRequestBody pipelineIdRequestBody) {
        execute(() -> {
            pipelinesHandler.deletePipeline(pipelineIdRequestBody.getPipelineId());
            return null;
        });
    }
    ...
    public PipelineReadList listPipelinesForWorkspace(final WorkspaceIdRequestBody workspaceIdRequestBody) {
        return execute(() -> pipelinesHandler.listPipelinesForWorkspace(workspaceIdRequestBody));
    }
    ...
    @Override
    public PipelineRead getPipeline(final PipelineIdRequestBody pipelineIdRequestBody) {
        return execute(() -> pipelinesHandler.getPipeline(pipelineIdRequestBody.getPipelineId()));
    }
    ...
    public PipelineRead updatePipeline(final PipelineUpdate pipelineUpdate) {
        return execute(() -> pipelinesHandler.updatePipeline(pipelineUpdate));
    }
    ...
    public WebBackendPipelineReadList webBackendListPipelinesForWorkspace(final WorkspaceIdRequestBody workspaceIdRequestBody) {
        return execute(() -> webBackendPipelinesHandler.webBackendListPipelinesForWorkspace(workspaceIdRequestBody));
    }
    ...
    public WebBackendPipelineReadList webBackendListAllPipelinesForWorkspace(final WorkspaceIdRequestBody workspaceIdRequestBody) {
        return execute(() -> webBackendPipelinesHandler.webBackendListAllPipelinesForWorkspace(workspaceIdRequestBody));
    }
    ...
    public WebBackendPipelineReadList webBackendSearchPipelines(final WebBackendPipelineSearch webBackendPipelineSearch) {
        return execute(() -> webBackendPipelinesHandler.webBackendSearchPipelines(webBackendPipelineSearch));
    }
    ...
    public WebBackendPipelineRead webBackendGetPipeline(final WebBackendPipelineRequestBody webBackendPipelineRequestBody) {
        return execute(() -> webBackendPipelinesHandler.webBackendGetPipeline(webBackendPipelineRequestBody));
    }
    ...
    public WebBackendPipelineRead webBackendCreatePipeline(final WebBackendPipelineCreate webBackendPipelineCreate) {
        return execute(() -> webBackendPipelinesHandler.webBackendCreatePipeline(webBackendPipelineCreate));
    }
    ...
    public WebBackendPipelineRead webBackendUpdatePipeline(final WebBackendPipelineUpdate webBackendPipelineUpdate) {
        return execute(() -> webBackendPipelinesHandler.webBackendUpdatePipelineNew(webBackendPipelineUpdate));
    }

...
public class ApiPojoConverters {
    ...
    public static io.airbyte.config.Pipeline pipelineUpdateToInternal(final PipelineUpdate update) throws JsonValidationException {

        final Pipeline newPipeline = new Pipeline();
    ...
    public static PipelineRead internalToPipelineRead(final Pipeline pipeline) {
        //noinspection UnnecessaryLocalVariable
        final PipelineRead pipelineRead = new PipelineRead()
                .pipelineId(pipeline.getPipelineId())
                .connectionId(pipeline.getConnectionId())
